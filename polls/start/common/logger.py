...
def _patch_print_exception():
	import traceback
	import sys
	# _print = traceback.print_stack  # pylint: disable=protected-access

	def _print(file, str='', terminator='\n'):
		file.write(str + terminator)

	def custom_print_exception(etype, value, tb, limit=None, file=None, chain=True): # pylint: disable=redefined-builtin
		if file is None:
			file = sys.stderr
